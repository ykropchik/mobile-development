...
internal abstract class EndlessRecyclerViewScrollListener : RecyclerView.OnScrollListener {
    ...
    override fun onScrolled(view: RecyclerView, dx: Int, dy: Int) {
        ...
        // Log.d("Scroll", "Loading: $loading, lastVisibleItemPosition: $lastVisibleItemPosition, previousTotalItemCount: $previousTotalItemCount, totalItemCount: $totalItemCount currentPage: $currentPage")
